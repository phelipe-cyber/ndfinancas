...
");
 ...
 while ($row_usuario = mysqli_fetch_assoc($recebidos)) {
    ...
    $id_end_servico_id = $row_usuario['end_servico_id'];
                ...
                <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                    ...
                    <!-- /.card-footer -->
                      ...
                      <input id="end_servico_id" name="end_servico_id" value="<?php echo $id_end_servico_id ?>" type="hidden" class="form-control" style="text-transform: uppercase;">
