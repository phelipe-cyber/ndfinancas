                            ...
                            <ul class="nav nav-pills flex-column">
                              ...
                              <li class="nav-item active">
                                <a class="nav-link">
                                  <div class="btn btn-default btn-file">
                                    <i class="fas fa-paperclip"></i> Foto Cliente
                                    <input onchange="getFileData_ftcliente(this);" type="file" name="foto[ftcliente]">
                                  </div>
                              ...
                              <li class="nav-item active">
                                <a class="nav-link">
                                  <div class="btn btn-default btn-file">
                                    <i class="fas fa-paperclip"></i> RG
                                    <input onchange="getFileData_ftrg(this);" type="file" name="foto[ftrg]">
                                  </div>
                              ...
                              <li class="nav-item active">
                                <a class="nav-link">
                                  <div class="btn btn-default btn-file">
                                    <i class="fas fa-paperclip"></i> CPF
                                    <input onchange="getFileData_ftcpf(this);" type="file" name="foto[ftcpf]">
                                  </div>
                              ...
                              <li class="nav-item active">
                                <a class="nav-link">
                                  <div class="btn btn-default btn-file">
                                    <i class="fas fa-paperclip"></i> Comprovante Residência
                                    <input onchange="getFileData_ftcomresi(this);" type="file" name="foto[ftcompres]">
                                  </div>
                              ...
                              <li class="nav-item active">
                                <a class="nav-link">
                                  <div class="btn btn-default btn-file">
                                    <i class="fas fa-paperclip"></i> Comprovante Comercial
                                    <input onchange="getFileData_ftcomercial(this);" type="file" name="foto[ftcompcomer]">
                                  </div>
                              ...
                              <li class="nav-item active">
                                <a class="nav-link">
                                  <div class="btn btn-default btn-file">
                                    <i class="fas fa-paperclip"></i> Termo
                                    <input onchange="getFileData_fttermo(this);" type="file" name="foto[fttermo]">
                                  </div>
                              ...
                              <li class="nav-item active">
                                <a class="nav-link">
                                  <div class="btn btn-default btn-file">
                                    ...
                                    <input onchange="getFileData_local(this);" type="file" name="foto[ftlocal]"   name="pecadetalhe[<?= $index ?>][destino]">
                                  </div>
                              ...
                              <li class="nav-item active">
                                <a class="nav-link">
                                  <div class="btn btn-default btn-file">
                                    ...
                                    <input onchange="getFileData_local_2(this);" type="file" name="foto[ftlocal2]">
                                  </div>
                              ...
                              <li class="nav-item active">
                                <a class="nav-link">
                                  <div class="btn btn-default btn-file">
                                    ...
                                    <input onchange="getFileData_local_3(this);" type="file" name="foto[ftlocal3]">
                                  </div>
