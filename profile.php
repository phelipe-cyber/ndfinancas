...
FROM `clientes` c LEFT JOIN fotos_clientes ft on ft.id_cliente = c.id LEFT JOIN clientes_endereco_servico ces on ces.id_cliente = c.id where c.id = $id and c.user_created = '$id_user' ");
