            ...
            <!-- <div class="col-lg-12"> -->
                <div class="col-5">
                    ...
                    <div class="form-group">
                        <label>Cliente</label>
                        <select id="cliente" name="cliente" class="form-control select2" style="width: 100%;">
    ...
    //   $("#valor").change(function() {
        ...
        let valor = conversor(document.getElementById("valor").value);
            ...
            //   console.log(valor);
                ...
                var juros = juros.toLocaleString('pt-br',{style: 'currency', currency: 'BRL'});
                var valor_bruto = valor_bruto.toLocaleString('pt-br',{style: 'currency', currency: 'BRL'});
