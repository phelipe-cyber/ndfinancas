                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Cadastrar Tipos de Clientes</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        ...
                                        <input id="nome_cliente" name="Nome Cliente" type="text" class="form-control">
                                        <br>
                                    </div>
                                </div>
                        ...
                        <div class="col-2">
                                <button type="submit" class="btn btn-block btn-success">Salvar Cliente </button>
                            </div>
